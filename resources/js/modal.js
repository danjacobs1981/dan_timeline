...
(function(factory) {
    ...
    $.modal.prototype = {
        ...
        block: function() {
            ...
            this.$blocker = $('<div class="' + this.options.blockerClass + ' modal-blocker current"></div>').appendTo(this.$body);
            selectCurrent();
            if (this.options.doFade) {
        ...
        show: function() {
            ...
            if (this.options.showClose) {
                this.closeButton = $('<a href="#close-modal" rel="modal:close" class="modal-close ' + this.options.closeClass + '">' + this.options.closeText + '</a>');
