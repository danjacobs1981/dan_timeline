<div id="timelinePrivacy">
    ...
    <div>
        ...
        <div class="privacy-share" style="{{ old('privacy', $timeline->privacy) === 1 ? '' : 'display:none;' }}">
            ...
            <a class="btn" href="{{ route('timelines.privacy-share.showModal', [ 'timeline' => $timeline->id ]) }}" data-modal data-modal-scroll data-modal-size="modal-sm" data-modal-showclose="false" data-modal-clickclose="false" data-modal-class="modal-timeline-privacy-share">
