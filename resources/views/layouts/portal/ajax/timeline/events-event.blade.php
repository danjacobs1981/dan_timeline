<div data-id="{{ $event->id }}" style="border:1px solid #000;padding:0.5rem;margin-bottom:0.5rem;">
    ...
    {{ $date }} <a class="change-date" href="{{ route('event.date.edit', [ 'timeline' => $event->timeline_id, 'event' => $event->id ]) }}" data-modal data-modal-class="modal-edit-event-date" data-modal-size="modal-sm" data-modal-showclose="false" data-modal-clickclose="false">Change</a><br/>
    {{ $event->title }}<br/>
