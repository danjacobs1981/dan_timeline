    ...
    @foreach($timeline_sources as $source)  
        <li class="source" data-id="{{ $source->id }}">
            ...
            <div>
                ...
                <a href="{{ route('timelines.sources.edit', [ 'timeline' => $source->timeline_id, 'source' => $source->id ]) }}" data-modal data-modal-scroll data-modal-class="modal-create-edit-source" data-modal-size="modal-md" data-modal-showclose="false" data-modal-clickclose="false">
