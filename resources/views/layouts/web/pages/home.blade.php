...
@section('content')
    ...
    <p><a data-modal data-modal-scroll data-modal-class="modal-login" data-modal-size="modal-md" data-modal-showclose="true" href="{{ route('login.showModal') }}">Login (modal)</a> | <a data-modal data-modal-scroll data-modal-class="modal-register" data-modal-size="modal-md" data-modal-showclose="true" href="{{ route('register.showModal') }}">Register (modal)</a></p>
    @endguest
