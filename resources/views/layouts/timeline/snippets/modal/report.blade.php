<p>
    If you find content on this timeline which you consider to be spam, harassment, or which violates <a href="#" target="_blank" title="Timelined.net's rules">Timelined.net's rules</a>, please report it to us by completing this form.
</p>

<p>
    There is also the option to suggest to the timeline creator to make an edit. This may be a good first-port-of-call to get any issues you may have resolved. <a data-modal data-modal-class="modal-suggestion" data-modal-size="modal-md" data-modal-showclose="true" href="{{ route('timeline.suggestion.showModal', [ 'timeline' => $timeline->id, 'event' => $event->id ]) }}">Click here to suggest an edit</a>.
</p>
...
<div class="control control--radio">
    ...
    <label class="control__label">Harassment
        <input type="radio" value="Harassment" name="category" checked />
        <div></div>
    </label>
