...
@section('content')
    ...
    @guest
        <div class="modal-login modal-md modal-scroll modal" id="modal-signup">
            @include('layouts.modal.master', [ 'route' => 'layouts.global.snippets.modal.login-register', 'modal_title' => 'Log In or Register', 'show' => 'login', 'incentive' => 'oops! You must login or register to do that!' ])
        </div>
    @endguest
